...
class SpamBot:
    ...
    def getPlayersFromServer(self, server_name):
        my_server = []

        for server in self.getServersList():
        ...
        directory_to_send = self._dir + "/" + self._filename + ".json"
    ...
    def getServersList(self, typeS=None):
    ...
    def getInformationAboutServers(self):
